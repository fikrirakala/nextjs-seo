...
export default function PrivacyPolicy() {
  return (
    <div className="m-auto max-w-prose space-y-3">
      ...
      <ol className="space-y-3">
        ...
        <li>
          <h2 className="text-lg font-bold">Cookies: Not the Tasty Kind</h2>
          <p>
        ...
        <li>
          <h2 className="text-lg font-bold">Third-Party Shenanigans</h2>
          <p>
        ...
        <li>
          <h2 className="text-lg font-bold">Changes? Oh, Yes, We Change</h2>
          <p>
        ...
        <li>
          <h2 className="text-lg font-bold">You&apos;re in Control... Kinda</h2>
          <p>
